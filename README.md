...
该项目为前后端分离项目的前端部分，后端项目`yida`地址：[传送门](https://github.com/zhaoxny/yida)。

## 项目介绍

`yida-admin-web`是一个电商后台管理系统的前端项目，基于Vue+Element实现。主要包括商品管理、订单管理、会员管理、促销管理、运营管理、内容管理、统计报表、财务管理、权限管理、设置等功能。
...
[Apache License 2.0](https://github.com/zhaoxny/yida-admin-web/blob/master/LICENSE)
